...
local function config_lightbub() require("nvim-lightbulb").setup({ autocmd = { enabled = true } }) end

local function config_hover()
	require("hover").setup({
		init = function() require("hover.providers.lsp") end,
	})
end

local function config_trouble()
...
local function config_dap() end

local function config_neotest()
	require("neotest").setup({
		adapters = {
			require("neotest-vim-test")({ ignore_filetypes = { "rust", "go" } }),
...
local config_glance = function() require("glance").setup({}) end

return function(use)
	use({ "lewis6991/hover.nvim", config = config_hover })
	use({ -- https://github.com/folke/trouble.nvim
		"folke/trouble.nvim",
		config = config_trouble,
	})
	...
	use({
		...
		requires = {
			"vim-test/vim-test", -- needed for running ts/playwright tests
			"nvim-neotest/neotest-vim-test", -- vim-test runner
			"rouge8/neotest-rust",
			"nvim-neotest/neotest-go",
		},
		after = { "plenary.nvim" },
		config = config_neotest,
	})
	use({
